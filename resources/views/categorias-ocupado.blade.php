...
@section('content')
    <br><br><br><br>
    <h2 class="title is-1">Agregar producto-Categorías de Mesa #{{ $Num_m }}</h2>
    <div class="has-text-left mb-4">
      <button class="button is-light is-medium" onclick=''>
        <span class="icon is-medium"><i class="fas fa-arrow-left"></i></span>
        <span class="is-size-5">Regresar a </span>
      </butt>
    </div>
    <div class="columns">
        <!-- CATEGORÍAS -->
                        ...
                        @foreach ($categorias as $categoria)
                            <div class="column is-4-desktop is-12-tablet is-6-mobile">
                                <div class="box has-text-centered">
                                    ...
                                    <a href="{{ url('/' . $categoria->Cod_cat) }}" class="button is-info is-fullwidth mt-3">
                    ...
                    <div class="column is-4-desktop is-6-tablet is-12-mobile">
                        <div class="box">
                            ...
                            <button class="button is-success color-button is-fullwidth">
                                <i class="fa-solid fa-plus"></i>&nbsp;Actualizar el Pedido
                            </button>
                        </div>
                    </div>
                @endforeach
